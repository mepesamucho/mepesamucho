...
// ── DAYPASS HELPERS ───────────────────────────────
// Daypass = 1 extra session purchasable for $19
...
/** Activate daypass for a single extra session ($19) */
          ...
          <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-2xl p-8 sm:p-10" style={{ boxShadow: "0 8px 32px rgba(0,0,0,0.12)" }}>
            ...
            <div className="flex flex-col gap-3 mt-6" style={{ maxWidth: "360px", margin: "0 auto" }}>
              <button
                ...
                aria-label="Comprar 1 sesión extra hoy por $19 MXN"
              >
                1 sesión extra hoy — $19 MXN
              </button>
              <button
                ...
                aria-label="Suscribirme por $99 MXN al mes para sesiones ilimitadas"
              >
                Ilimitado este mes — $99 MXN/mes
              </button>
            </div>
            ...
            <div className="flex items-center justify-center gap-1.5 mt-5">
              ...
              <p className="font-[var(--font-sans)] text-[0.75rem] text-[var(--color-text-tertiary)]">Cobro seguro vía Stripe · Precios en MXN</p>
            </div>
        ...
        <div className={`${S.page} animate-fade-in pt-16`} key={`c3f-${fadeKey}`}>
          ...
          <div className={`${S.box} text-center`}>
            ...
            <div className="flex flex-col gap-3 items-center max-w-[380px] mx-auto">
              <button className={`${S.btn} btn-primary-glow w-full`} onClick={() => { setCheckoutError(""); checkout("single", undefined, setCheckoutError); }} aria-label="Continuar conversación por $19 MXN">Continuar conversación — $19 MXN</button>
              <button className={`${S.btnSecondary} w-full text-sm`} onClick={() => { setCheckoutError(""); checkout("subscription", undefined, setCheckoutError); }} aria-label="Suscripción mensual $99 MXN">Reflexiones ilimitadas · $99 MXN/mes</button>
        ...
        <div style={{ maxWidth: "680px", width: "100%", margin: "0 auto", paddingLeft: "1.5rem", paddingRight: "1.5rem", paddingTop: "5rem", paddingBottom: "3rem" }}>
          ...
          {!continuacionDesbloqueada && (
            <div className="mt-10 animate-fade-in" style={{ textAlign: "center", width: "100%" }}>
              ...
              <div className="flex flex-col gap-3 items-center" style={{ maxWidth: "320px", margin: "0 auto" }}>
                <button className={`${S.btn} btn-primary-glow`} style={{ width: "100%", maxWidth: "320px" }} onClick={() => { setCheckoutError(""); checkout("single", undefined, setCheckoutError); }} aria-label="Continuar esta reflexión por $19 MXN">Continuar esta reflexión — $19 MXN</button>
                <button className={`${S.btnSecondary} text-sm`} style={{ width: "100%", maxWidth: "320px" }} onClick={() => { setCheckoutError(""); checkout("subscription", undefined, setCheckoutError); }} aria-label="Suscripción mensual $99 MXN">Reflexiones ilimitadas · $99 MXN/mes</button>
                {checkoutError && <p className="font-[var(--font-sans)] text-[0.8rem] text-red-700 mt-2">{checkoutError}</p>}
